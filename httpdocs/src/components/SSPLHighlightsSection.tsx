...
const SSPLHighlightsSection = () => {
  console.log('🎯 SSPL Highlights Section rendering...');
  ...
  const highlights = [
    ...
    },
    {
      ...
      description: "Rising stars of SSPL T10"
    },
    {
      image: "/image_15.png",
      title: "Match Highlights",
      description: "Best plays from recent matches"
    },
    {
      image: "/image_29.png",
      title: "Victory Moments",
      description: "Celebrating championship wins"
    }
  ];

  console.log('📸 Highlights images:', highlights);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Relive the most exciting moments from SSPL T10 tournaments!
          </p>
        </div>

        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start" style={{ minHeight: '400px' }}>
              ...
              <div className="relative group cursor-pointer max-w-sm" onClick={() => openModal(1)}>
                <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
                  <img
                    ...
                    decoding="async"
                    onError={(e) => {
                      console.log('Left column image failed to load:', highlights[1]?.image);
              ...
              <div className="relative group cursor-pointer max-w-md" onClick={() => openModal(0)}>
                <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
                  <img
                    ...
                    decoding="async"
                    onError={(e) => {
                      console.log('Center column image failed to load:', highlights[0]?.image);
                      e.currentTarget.src = "/placeholder.svg";
                    }}
                  />
              ...
              <div className="relative group cursor-pointer" onClick={() => openModal(2)}>
                <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
                  <img
                    ...
                    decoding="async"
                    onError={(e) => {
                      console.log('Right column top image failed to load:', highlights[2]?.image);
                      e.currentTarget.src = "/placeholder.svg";
                    }}
                  />
                  <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-sm rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="relative group cursor-pointer" onClick={() => openModal(3)}>
                <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
                  <img
                    ...
                    decoding="async"
                    onError={(e) => {
                      console.log('Right column bottom image failed to load:', highlights[3]?.image);
                      e.currentTarget.src = "/placeholder.svg";
                    }}
                  />
                  <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-sm rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <div className="relative max-w-4xl max-h-full" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="relative">
                <img
                  ...
                  decoding="async"
                  onError={(e) => {
                    console.log('Modal image failed to load:', selectedImage.image);
                    e.currentTarget.src = "/placeholder.svg";
                  }}
                />
