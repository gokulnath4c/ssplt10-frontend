      ...
      <Dialog open={isTeamDialogOpen} onOpenChange={setIsTeamDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {editingItem ? 'Update the team information below.' : 'Create a new team by filling out the form below.'}
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isPlayerDialogOpen} onOpenChange={setIsPlayerDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Add a new player to the SSPL roster by filling out the form below with their details and team assignment.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
      ...
      <Dialog open={isFaqDialogOpen} onOpenChange={setIsFaqDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new frequently asked question and answer pair to help users with common inquiries.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
      ...
      <Dialog open={isChatbotDialogOpen} onOpenChange={setIsChatbotDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new automated response for the chatbot by defining trigger keywords and the corresponding response text.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
