...
const RegistrationsTab = ({
        ...
        <body>
          ...
          <div class="details">
            ...
            <div class="detail-row">
              ...
              <span class="value">${receiptData.preferredTrials}</span>
            </div>
            ` : ''}
            <div class="detail-row">
  ...
  const exportToExcel = () => {
    const csvContent = [
      ['Player ID', 'Registration ID', 'Full Name', 'Email', 'Phone', 'Date of Birth', 'Position', 'State', 'City', 'Town', 'PIN Code', 'Preferred Trials', 'Payment Amount', 'Payment Status', 'Registration Status', 'Registration Date'].join(','),
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-cricket-light-blue/30 hover:bg-cricket-light-blue/40">
                    ...
                    <TableHead className="font-semibold text-cricket-blue">Preferences</TableHead>
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="space-y-1 text-sm">
                          ...
                          {!player.preferred_trials && <span className="text-muted-foreground">Not specified</span>}
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="space-y-1 text-sm">
