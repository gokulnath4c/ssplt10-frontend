        ...
        <TabsContent value="individual" className="space-y-6">
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Configure the settings for your new QR code including target URL, template, and optional restrictions.
              </DialogDescription>
            </DialogHeader>
      ...
      <Dialog open={showAnalyticsDialog} onOpenChange={setShowAnalyticsDialog}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription>
              View detailed analytics and performance metrics for the selected QR code including scan trends, device information, and geographic data.
            </DialogDescription>
          </DialogHeader>
