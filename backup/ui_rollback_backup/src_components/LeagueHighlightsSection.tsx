...
const LeagueHighlightsSection = () => {
  ...
  return (
    <section className="relative py-6 bg-gradient-to-br from-cricket-blue via-cricket-dark-blue to-cricket-purple text-white overflow-hidden">
      {/* Premium Floating Elements */}
      <PremiumFloatingElements variant="moderate" className="opacity-30" />

      <div ref={highlightsSectionRef.ref as any} className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
