        ...
        <ScrollArea className="h-[60vh] pr-4">
          <div className="space-y-6 text-sm">
            <div className="text-center mb-6">
              <h1 className="text-2xl font-bold text-cricket-blue mb-2">Terms & Conditions</h1>
              <p className="text-muted-foreground">
                <strong>Last updated: July 7, 2025</strong>
              </p>
            </div>
            
            <div className="space-y-4">
              <p className="text-justify">
                <strong>1.</strong> This document is an electronic record in terms of Information Technology Act, 2000 and rules made thereunder and as the same may be amended from time to time. Being a system generated electronic record, it does not require any physical or digital signature.
              </p>

              <p className="text-justify">
                <strong>2.</strong> Greetings from Southern Streets Premier League T10 (SSPL) (hereinafter referred to as the Website). The Website is owned by Royal Peacocks League Limited, having its registered address at 564 Anna salai, Teynampet, Chennai, Tamilnadu, India 600018. Royal Peacocks League Limited is a pioneering sports management company committed to bringing innovative and inclusive sporting experiences to enthusiasts across the nation.
              </p>

              <p className="text-justify">
                <strong>3.</strong> Royal Peacocks League Limited has conceptualized as well as is the owner (League Owner) of a men's T-10 tennis ball cricket league under the name and style of SSPL T10 (SSPL) or such other name and style as may be adopted from time to time at League Owners sole discretion.
              </p>

              <p className="text-justify">
                <strong>4.</strong> The SSPL is a pioneering Tennis Ball Cricket League with a primary mission to discover, nurture, and elevate cricketers from grassroots levels. It endeavours to unite the finest local cricket talent in India, creating a comprehensive platform for players to showcase their skills. The league aspires to transcend boundaries and establish itself as an international platform, fostering the growth of future cricketing superstars while adding structure to the cricket scene in cities.
              </p>

              <p className="text-justify">
                <strong>5.</strong> SSPL is committed to bridging the gap between street cricket and stadium glory, aiming to bring the raw energy and talent of street cricket onto the grand stage. The player selection process involves handpicking players from each state across India, ensuring representation from every corner of the nation and thereby enhancing the value for stakeholders involved.
              </p>

              <p className="text-justify">
                <strong>6.</strong> The Southern Streets Premier League shall consist of a total of 10 playing seasons and season 1 of the Southern Streets Premier League will comprise of 12 teams who shall participate in the SSPL to be played in India. The said 12 teams shall consist of players who shall be shortlisted as per Clause 1 of these Terms.
              </p>

              <p className="text-justify">
                <strong>7.</strong> By accessing the Website from any computer, computer device, mobile, smartphone or any electronic device, you expressly agree to be bound by these Terms and Conditions (hereinafter referred to as the Terms).
              </p>

              <p className="text-justify">
                <strong>8.</strong> If you use or access the Website, you are required to first carefully read as well as fully understand these Terms which are applicable when you view/access/use the Website. Please also carefully read and fully understand our Privacy Policy available at the link https://www.ssplt10.co.in/privacy-policy (hereinafter referred to as the Privacy Policy), which is incorporated in these Terms by reference.
              </p>

              <p className="text-justify">
                <strong>9.</strong> If, for any reason, you do not agree to these Terms, Privacy Policy and/or other Website guidelines and policies (guidelines and policies hereinafter collectively referred to as Other Policies ) as communicated to you when you access the Website or do not wish to be bound by them, please do not use the Website in any way whatsoever. By using or accessing the Website, you have expressly indicated to us that you have read, acknowledged and understood as well as fully agreed, to be bound by these Terms, Privacy Policy and all Other Policies, irrespective whether you register with the Website or create a Website account or not.
              </p>

              <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                <p className="text-justify font-medium">
                  <strong>Below 12 years:</strong> Will be considered as guest participants.
                </p>
                <p className="text-justify font-medium">
                  <strong>Foreign Players:</strong> Must pay $60 registration and should not use SSPL's player registration for VISA processing.
                </p>
                <p className="text-justify font-medium">
                  <strong>Legal disputes:</strong> Will be handled in Chennai, Tamil Nadu, India courts only.
                </p>
              </div>
            </div>

            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-cricket-blue mt-6">Website Purpose:</h3>
              <p className="text-justify">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-cricket-blue mt-6">Acceptance of Terms, etc:</h3>
              <p className="text-justify">
              ...
              <h3 className="text-lg font-semibold text-cricket-blue mt-6">Eligibility:</h3>
              <p className="text-justify">
              ...
              <h3 className="text-lg font-semibold text-cricket-blue mt-6">Website Account:</h3>
              <p className="text-justify">
