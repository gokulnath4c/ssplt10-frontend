...
const SSPLAnthemSection = () => {
  ...
  return (
    <section className="relative py-12 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-white overflow-hidden">
      {/* Premium Floating Elements */}
      <PremiumFloatingElements variant="moderate" className="opacity-30" />

      <div ref={anthemSectionRef.ref as any} className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
