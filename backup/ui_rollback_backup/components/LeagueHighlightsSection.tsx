    ...
    <section className="py-6 bg-gradient-to-br from-cricket-blue via-cricket-dark-blue to-cricket-purple text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-2 bg-gradient-to-r from-white to-yellow-300 bg-clip-text text-transparent">
            League Highlights
          </h2>
          <p className="text-sm md:text-base text-gray-100 max-w-2xl mx-auto leading-relaxed font-medium">
            Discover the excitement of SSPL T10 - where cricket meets championship glory!
          </p>
        </div>
