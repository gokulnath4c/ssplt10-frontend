      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <div className="flex items-center justify-center mb-4">
            <Camera className="w-8 h-8 text-cricket-blue mr-3" />
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-cricket-blue to-cricket-purple bg-clip-text text-transparent">
              SSPL Highlights
            </h2>
            <Camera className="w-8 h-8 text-cricket-blue ml-3" />
          </div>
