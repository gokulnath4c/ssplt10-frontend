...
const CricketOrganizerDealsSection = () => {
  return (
    <section className="py-12 bg-gradient-to-br from-yellow-50 via-green-50 to-lime-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-yellow-600 via-green-600 to-lime-600 bg-clip-text text-transparent">
