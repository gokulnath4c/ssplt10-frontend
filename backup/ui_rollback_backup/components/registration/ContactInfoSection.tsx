...
const ContactInfoSection: React.FC<ContactInfoSectionProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-lg border border-blue-200/50">
      <h4 className="text-sm font-bold text-cricket-blue mb-3 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 gap-2">
        ...
        <div className="space-y-2">
          <Label htmlFor="email" className="text-cricket-blue font-semibold text-sm flex items-center gap-2">
            <Mail className="w-3.5 h-3.5 text-cricket-blue" />
            Email Address
          </Label>
          <EnhancedInput
            id="email"
        ...
        {/* Phone Input */}
        <div className="space-y-2">
          <Label htmlFor="phone" className="text-cricket-blue font-semibold text-sm flex items-center gap-2">
            <Phone className="w-3.5 h-3.5 text-cricket-blue" />
            Phone Number
          </Label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 pl-16 pr-3 py-2 text-sm border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-cricket-blue focus:border-cricket-blue bg-white cursor-text transition-all duration-200 hover:border-cricket-blue/50"
              maxLength={10}
              autoComplete="tel"
            />
